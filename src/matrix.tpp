...
template <typename _T>
size_t MatrixBase<_T>::get_n_rows() const {
    return rows;
}

template <typename _T>
size_t MatrixBase<_T>::get_n_cols() const {
    return cols;
}

// legacy get and set methods
template <typename _T>
...
template <typename _T>
_T& Matrix<_T>::operator()(size_t row, size_t col) {
...
template <typename _T>
const _T& Matrix<_T>::operator()(size_t row, size_t col) const {
    this->validate(row, col);
...
template <typename _T>
_T MatrixDiagonal<_T>::get(size_t i, size_t j) const {
    this->validate(i, j);
...
template <typename _T>
void MatrixDiagonal<_T>::set(size_t i, size_t j, _T val) {
    this->validate(i, j);
